    ...
    <nav className="fixed w-full h-[85px] top-0 z-[1000] bg-[rgba(3,3,3,0.8)] backdrop-blur border-b-2 border-[rgb(24,24,24)]">
      <div className="max-w-[1450px] mx-auto flex justify-between items-center">
        ...
        <div className="nav-links">
          ...
          <button className='px-6 py-2 bg-gradient-to-r from-blue-500 to-violet-500 text-white font-semibold rounded-full hover:bg-gradient-to-l hover:scale-105 transition-all duration-300 ease-in-out'>Sign Up</button>
